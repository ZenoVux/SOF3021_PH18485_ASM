...
<c:set var="title" value="Cập nhật dơn hàng chi tiết" />
<%@ taglib uri="http://www.springframework.org/tags/form" prefix="f"%>
<c:set var="menuId" value="7" />
<%@include file="../_header.jsp"%>
<div class="row">
	<div class="mx-auto" style="max-width: 600px;">
		<h3 class="text-center my-3">Cập nhật đơn hàng chi tiết</h3>
		...
		<f:form method="POST"
			action="${pageContext.request.contextPath}/admin/order-details/update"
			modelAttribute="data">
